    ...
    <div class="space_between">
      <div class="book">
        ...
        <div class="likes">
          ...
          <span class="current_likes">10 likes</span>
        </div>
        <div class="book_details">
          <span class="author">by:</span>
          <span class="published">published year</span>
        </div>
      </div>
...
function showLibrary() {
  for (let index = 0; index < books.length; index++) {
    ...
    document.getElementsByClassName("title")[index].innerHTML = Object.values(bookObject)[0];
    document.getElementsByClassName("genre")[index].innerHTML = Object.values(bookObject)[6];
    document.getElementsByClassName("current_likes")[index].innerHTML = Object.values(bookObject)[2];
    document.getElementsByClassName("author")[index].innerHTML = "by: " + Object.values(bookObject)[1];
    document.getElementsByClassName("published")[index].innerHTML = "(" + Object.values(bookObject)[5] + ")";
    document.getElementsByClassName("price")[index].innerHTML = Object.values(bookObject)[4]+"€";
...
function toggleLike(index) {
  document
    .getElementsByClassName("like_button")
    [index].classList.toggle("liked");
